...
public class OfferServiceImpl implements OfferService {
    ...
    public List<String> addOffer(OfferDTO offerDTO, String username) {
        if (this.validator.isValid(offerDTO)) {
            ...
            UserEntity fetchedUserEntity = this.userRepository
                    .findUserByUsername(username)
                    .orElseThrow(() -> new IllegalArgumentException("Invalid user"));

            Offer offer = mapToOffer(offerDTO, model, fetchedUserEntity);
    ...
    private Offer mapToOffer(OfferDTO offerDTO, Model model, UserEntity userEntity) {
